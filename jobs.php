                ...
                <ul class="nav nav-pills nav-stacked tree" data-widget="tree">
                  <li class="treeview menu-open">
                    ...
                    <ul class="treeview-menu">
                      <li><a href=""  class="citySearch" data-target=""><i class="fa fa-circle-o text-yellow"></i> Islamabad</a></li>
                      <li><a href="" class="citySearch" data-target=""><i class="fa fa-circle-o text-yellow"></i> Karachi</a></li>
                    </ul>
                  </li>
                  <li class="treeview menu-open">
